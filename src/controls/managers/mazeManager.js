export var MazeManager = {
  ...
  gridElements: function() {
    ...
    // Top border.
    for (var i = 0; i <= MazeManager.grid[0].length * 2; i++) {
      elements.push(MazeManager.CELL.CLOSED);
    }

    elements.push(MazeManager.CELL.CLEAR);
    ...
    for (var y = 0; y < MazeManager.grid.length; y++) {
      ...
      // Left border column.
      elements.push(MazeManager.CELL.CLOSED);
      passageRow.push(MazeManager.CELL.CLOSED);
      ...
      for (var x = 0; x < MazeManager.grid[0].length; x++) {
        ...
        elements.push(MazeManager.CELL.OPEN);
        ...
        if (
          ...
          passageRow.push(MazeManager.CELL.OPEN);
        } else {
      ...
      elements.push(MazeManager.CELL.CLEAR);
      passageRow.push(MazeManager.CELL.CLEAR);
